  ...
  return (
    <DocsLayout>
      <div className="docs-prose">
        ...
        <p>Proper DNS configuration is critical for email deliverability. This page explains each record and how cold mail uses them.</p>
        ...
        <ul>
          <li>Cold mail auto-generates the SPF value using your server&apos;s public IP</li>
        ...
        <ul>
          <li>Cold mail generates a 2048-bit RSA key pair when you add a domain</li>
        ...
        <h2>Verification</h2>
        <p>Cold mail performs real DNS lookups when you click &quot;Verify&quot;:</p>
        <ul>
